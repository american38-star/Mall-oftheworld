<template>    
  <div class="game-page">    
    ...
    <div v-if="!gameOpened" class="tabs">
      ...
      >
        <img :src="tab.icon" :alt="tab.name" class="tab-icon-img" />
    ...
    <div v-if="gameOpened" class="game-fullscreen">
      <!-- Şanslı Rulet - يتم استدعاؤها من components -->
      <SansliRulet 
        v-if="selectedGame === 'rulet'"
...
import SansliRulet from "@/components/games/SansliRulet.vue";
...
export default {    
  ...
  data() {    
    return {    
      ...
      gamesList: [
        { id: 'rulet', name: 'Şanslı Rulet', icon: require('@/assets/images/roulette-wheel.png') }
      ],
      balance: 0,    
      gameError: ""
    };    
